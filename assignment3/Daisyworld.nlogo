globals [
  ...
  num-yellows           ;; the number of yellow daisies
...
to seed-yellows-randomly
  ask n-of floor ((start-%-yellows * count patches) / 100) patches with [not any? daisies-here]
      [ sprout-daisies 1 [set-as-yellow]]
end
...
to set-as-yellow ;; turtle procedure
  set color yellow
  set albedo albedo-of-yellows
  set age 0
  set size 0.6
end
  ...
  [
     ...
     if (random-float 1.0 < seed-threshold) [
       ...
       [
        ...
        if (color = yellow)
         [
           ask seeding-place [sprout-daisies 1 [set-as-yellow]  ]
         ]
       ]
     ]
  ]
    ...
    ask patch mouse-xcor mouse-ycor [
      ...
      [
        ...
        if paint-daisies-as = "add white"
          [sprout-daisies 1 [set-as-white]]
        if paint-daisies-as = "add yellow"
          [sprout-daisies 1 [set-as-yellow]]
      ]
      [
